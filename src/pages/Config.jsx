    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-base-content/80 mt-2">
          Atur jam operasional pelayanan antrian
        </p>
      </div>
      ...
      <div className="alert alert-info mt-6">
        ...
        <div>
          ...
          <div className="text-sm">
            ...
            layanan antrian. Pastikan jam tutup lebih besar dari jam buka.
          </div>
        </div>
      </div>
      ...
      {hasData && (
        <div className="card bg-3 shadow-xl mt-6">
          <div className="card-body">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div className="stat bg-base-100 rounded-lg border-warning border shadow-lg">
              ...
              <div className="stat bg-base-100 rounded-lg border border-neutral shadow-lg">

...
export default function ReportManagement() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      await reportService.exportVisitors({
        start_date: formData.start_date,
        end_date: formData.end_date,
        include_services: formData.include_services,
      });
  ...
  const handleToggleServices = () => {
    setFormData({ ...formData, include_services: !formData.include_services });
  };
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="text-center md:text-left">
          ...
          <p className="text-sm text-base-content/70 mt-1">
            Kelola dan export laporan data kunjungan
          </p>
        </div>
        ...
        <div className="card bg-white shadow-xl border-2 border-[#ceab93]">
          <div className="card-body p-4 md:p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-[#ad8b73]">
                  Pilih rentang tanggal dan opsi laporan
                </p>
              </div>
            </div>
            ...
            <div className="form-control mb-4">
              <label className="flex flex-row items-center cursor-pointer justify-start gap-4 p-3 md:p-4 bg-gradient-to-r from-[rgba(227,202,165,0.2)] to-[rgba(255,251,233,0.2)] rounded-lg hover:from-[rgba(227,202,165,0.3)] hover:to-[rgba(255,251,233,0.3)] transition-all border-2 border-[#ceab93]/50 hover:border-[#ad8b73]">
                <input
                  type="checkbox"
                  checked={formData.include_services}
                  onChange={handleToggleServices}
                  className="checkbox checkbox-lg border-2 border-[#ceab93] [--chkbg:#8c6a4b] [--chkfg:#fffbe9]"
                />
                <div className="flex-1">
                  <span className="font-bold text-[#8c6a4b] text-sm md:text-base flex items-center gap-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5"
                      viewBox="0 0 20 20"
                    ...
                    Sertakan Laporan Per Layanan
                  </span>
                  <p className="text-xs md:text-sm text-[#ad8b73] mt-1">
                    Laporan akan mencakup detail kunjungan per layanan di bawah
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <SummaryCard
              ...
              gradient="from-[#e3caa5] to-[#fffbe9]"
            />
          </div>
        )}
